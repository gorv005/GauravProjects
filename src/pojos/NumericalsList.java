...
public class NumericalsList implements Serializable {
     ...
     * @param lectureName
     */
    public NumericalsList(String lectureId, String lectureName, String lectureShortName, List<TopicDetail> topicDetail) {
        super();
